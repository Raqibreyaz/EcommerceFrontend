...
import { fetchProductDetailsAsync } from '../ProductSlice'
...
export default function ProductDetails() {
  ...
  const providedProduct = useSelector(state => state.product.currentProduct) || { images: [], thumbnail: { url: '' } }
  console.log(providedProduct);

  const product = {
    name: providedProduct.product_name,//'Basic Tee 6-Pack',
    price: '$192',
    href: '#',
    breadcrumbs: [
      { id: 1, name: 'Men', href: '#' },
