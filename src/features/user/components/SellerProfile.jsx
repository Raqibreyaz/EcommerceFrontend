...
function SellerProfile() {
    ...
    const { data: { products = [] } = {}, isLoadingProducts } = useFetchProductsQuery(`product_owners=${userId}`)

    const { data: { profileDetails } = {}, isLoading: isLoadingProfile } = useFetchProfileDetailsQuery(userId)
