...
import { addNewProductAsync } from '../features/product-list/ProductSlice';
                    ...
                    <div key={field.id} className="border p-4 rounded-lg space-y-2">
                        <div className="flex space-x-2">
                            <Controller
                                ...
                                control={control}
                                render={({ field }) => (
                                    <input {...field} type="text" placeholder="Color" className="border p-2 rounded"
                                        onChange={(e) => {
                                            field.onChange(e)
                                            handleChange('colors', e.target.value, index)
                                        }} />
                                )}
                                rules={{ required: true }}
                            />
