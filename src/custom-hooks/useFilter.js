...
export const useFilter = () => {
    ...
    const {
        data: { productOwners = [] } = {},
        isLoading: isLoadingProductOwners
    ...
    // adds or remove the  field and values
    ...
    // adds or removes the field for values
    ...
    return { products, categories, isLoadingCategories, isLoadingProductOwners, isLoadingProducts, productOwners, filteredTotal, totalPages, HandleFilterSelection, HandleSortSelection }
}
