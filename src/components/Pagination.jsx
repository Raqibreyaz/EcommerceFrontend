...
const Pagination = memo(function ({ limit = 10 }) {

    const { totalPages, filteredTotal, HandleFilterSelection } = useFilter()
    ...
    const handlePageChange = (index) => {
        ...
        HandleFilterSelection(false, 'page', index)
    }
            ...
            <div className="hidden sm:flex sm:flex-1 sm:items-center sm:justify-between">
                ...
                <div>
                    <nav className="isolate inline-flex -space-x-px rounded-md shadow-sm" aria-label="Pagination">
                        ...
                        <PageNumberCompo totalPages={totalPages} page={page} handlePageChange={handlePageChange} />
                        <button
                            onClick={() => handlePageChange(page + 1)}
                            disabled={page === totalPages}
...
function PageNumberCompo({ totalPages, page, handlePageChange }) {
